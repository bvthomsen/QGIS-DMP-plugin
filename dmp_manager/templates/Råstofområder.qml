...
<qgis version="3.22.0-Białowieża" styleCategories="Symbology|Legend">
  <renderer-v2 attr="statuskode-id" referencescale="-1" type="categorizedSymbol" symbollevels="0" forceraster="0" enableorderby="0">
    <categories>
      <category value="0" render="false" symbol="0" label="Ukendt"/>
      <category value="2" render="true" symbol="1" label="Forslag"/>
      <category value="3" render="true" symbol="2" label="Gældende / Vedtaget"/>
      <category value="4" render="false" symbol="3" label="Ikke gældende / Aflyst"/>
      <category value="" render="false" symbol="4" label=""/>
    </categories>
    <symbols>
