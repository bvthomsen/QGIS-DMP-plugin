...
<qgis readOnly="0" version="3.16.3-Hannover" maxScale="0" simplifyDrawingHints="1" simplifyLocal="1" simplifyAlgorithm="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyDrawingTol="1" labelsEnabled="0">
  ...
  <customproperties>
    <property value="&quot;objekt-id&quot;" key="dualview/previewExpressions"/>
    <property value="0" key="embeddedWidgets/count"/>
    <property value="DMPManager" key="variableNames"/>
    <property value="ramsar_omr" key="variableValues"/>
  </customproperties>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="oprindkode_id_f7371011_8e73_4631_a17f_e1d864f90771" type="QString" name="Layer"/>
            <Option value="oprindkode-id" type="QString" name="LayerName"/>
            <Option value="memory" type="QString" name="LayerProviderName"/>
            <Option value="None&amp;uid={458b4252-f37a-4986-b704-f878b1d4293e}" type="QString" name="LayerSource"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="" type="QString" name="FilterExpression"/>
            <Option value="key" type="QString" name="Key"/>
            <Option value="statuskode_id_65ee405c_00bf_42a5_bb60_ac5af2b84890" type="QString" name="Layer"/>
            <Option value="statuskode-id" type="QString" name="LayerName"/>
            <Option value="memory" type="QString" name="LayerProviderName"/>
            <Option value="None&amp;uid={2d1b3697-a0ca-4477-886e-5fe8e2b0d976}" type="QString" name="LayerSource"/>
            <Option value="1" type="int" name="NofColumns"/>
            <Option value="false" type="bool" name="OrderByValue"/>
            <Option value="false" type="bool" name="UseCompleter"/>
            <Option value="value" type="QString" name="Value"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="" type="QString" name="FilterExpression"/>
            <Option value="key" type="QString" name="Key"/>
            <Option value="off_kode_id_08c5db86_c0a9_4d78_aef2_00060c5dbc78" type="QString" name="Layer"/>
            <Option value="off-kode-id" type="QString" name="LayerName"/>
            <Option value="memory" type="QString" name="LayerProviderName"/>
            <Option value="None&amp;uid={01026009-97b0-4972-abb6-4fe703c88acc}" type="QString" name="LayerSource"/>
            <Option value="1" type="int" name="NofColumns"/>
            <Option value="false" type="bool" name="OrderByValue"/>
            <Option value="false" type="bool" name="UseCompleter"/>
            <Option value="value" type="QString" name="Value"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="" type="QString" name="FilterExpression"/>
            <Option value="key" type="QString" name="Key"/>
            <Option value="cvr_kode_id_f0d2b7d9_bc7e_4e70_b4e2_057b8b52a43a" type="QString" name="Layer"/>
            <Option value="cvr-kode-id" type="QString" name="LayerName"/>
            <Option value="memory" type="QString" name="LayerProviderName"/>
            <Option value="None&amp;uid={6b58b9a6-73ff-47b2-a598-5572892ef5d7}" type="QString" name="LayerSource"/>
            <Option value="1" type="int" name="NofColumns"/>
            <Option value="false" type="bool" name="OrderByValue"/>
            <Option value="false" type="bool" name="UseCompleter"/>
            <Option value="value" type="QString" name="Value"/>
  ...
  <aliases>
    ...
    <alias index="15" field="gyldig-fra" name="Start på gyldighedsperiode"/>
    <alias index="16" field="gyldig-til" name="Slut på gyldighedsperiode"/>
  </aliases>
  <defaults>
